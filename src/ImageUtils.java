...
public class ImageUtils {
	...
	public static void main(String[] args) {
		// 1-縮放圖像：
		// 方法一：按比例縮放
//		ImageUtils.scale("/home/zipe/tmp/test1.png", "/home/zipe/tmp/test1_scale.png", 2, true);// 測試OK
//		// 方法二：按高度和寬度縮放
//		ImageUtils.scale2("/home/zipe/tmp/test1.png", "/home/zipe/tmp/test1_scale2.png", 500, 300, true);// 測試OK
//
//		// 2-切割圖像：
//		// 方法一：按指定起點坐標和寬高切割
//		ImageUtils.cut("/home/zipe/tmp/test1.png", "/home/zipe/tmp/test1_cut.png", 0, 0, 400, 400);// 測試OK
//		// 方法二：指定切片的行數和列數
//		ImageUtils.cut2("/home/zipe/tmp/test1.png", "/home/zipe/tmp/", 2, 2);// 測試OK
//		// 方法三：指定切片的寬度和高度
//		ImageUtils.cut3("/home/zipe/tmp/test1.png", "/home/zipe/tmp/", 300, 300);// 測試OK
//
//		// 3-圖像類型轉換：
//		ImageUtils.convert("/home/zipe/tmp/test1.png", "GIF", "/home/zipe/tmp/test1_convert.gif");// 測試OK
//
//		// 4-彩色轉黑白：
//		ImageUtils.gray("/home/zipe/tmp/test1.png", "/home/zipe/tmp/test1_gray.jpg");// 測試OK
//
//		// 5-给圖片添加文字水印：
		// 方法一：
		ImageUtils.pressText("我是水印文字", "/home/zipe/tmp/test3.jpg", "/home/zipe/tmp/test1_pressText.jpg",
				"宋體", Font.BOLD, Color.white, 80, 0, 0, 0.5f);// 測試OK
		// 方法二：
		ImageUtils.pressText2("我也是水印文字", "/home/zipe/tmp/test3.jpg", "/home/zipe/tmp/test1_pressText2.jpg",
				"黑體", 36, Color.white, 80, 0, 0, 0.5f);// 測試OK

//		// 6-给圖片添加圖片水印：
//		ImageUtils.pressImage("/home/zipe/tmp/test1.png", "/home/zipe/tmp/test3.jpg",
//				"/home/zipe/tmp/test1_pressImage.jpg", 0, 0, 0.5f);// 測試OK
	}
